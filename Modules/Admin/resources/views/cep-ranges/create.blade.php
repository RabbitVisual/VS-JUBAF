            ...
            <div class="relative p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        <span class="px-3 py-1 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-bold uppercase tracking-wider">Nova Faixa</span>
                        <span class="px-3 py-1 rounded-full bg-green-500/20 border border-green-400/30 text-green-300 text-xs font-bold uppercase tracking-wider">Território</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-black tracking-tight mb-2">Cadastrar Faixa de CEP</h1>
                    <p class="text-gray-300 max-w-xl">Defina as regras geográficas para entregas. Selecione estado, cidade e intervalo de CEP sem colidir com faixas existentes.</p>
                </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-72 flex-shrink-0">
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 relative overflow-hidden group">
                    ...
                    <div class="relative">
                        <p class="text-gray-500 dark:text-gray-400 text-xs font-bold uppercase tracking-wider mb-4 px-1">Passos</p>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30">
                                <span class="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 font-black">1</span>
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Selecione o Estado (UF)</span>
                            </div>
                            <div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600">
                                <span class="w-10 h-10 rounded-xl bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-gray-600 dark:text-gray-400 font-black">2</span>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Defina a Cidade</span>
                            </div>
                            <div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600">
                                <span class="w-10 h-10 rounded-xl bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-gray-600 dark:text-gray-400 font-black">3</span>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Intervalo de CEP</span>
                            </div>
                        </div>
                        <p class="mt-6 text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                            O sistema usa estas faixas para validar endereços de entrega. Evite sobreposição de intervalos.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-1 min-w-0">
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 relative overflow-hidden group">
                    ...
                    <div class="relative">
                        <form action="{{ route('admin.cep-ranges.store') }}" method="POST" class="space-y-8" onsubmit="window.dispatchEvent(new CustomEvent('loading-overlay:show', { detail: { message: 'Salvando faixa...' } }))">
                            @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="uf" id="uf" required
                                        class="w-full px-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
                                        ...
                                        <input type="text" name="cidade" id="cidade" value="{{ old('cidade') }}" required placeholder="Ex: São Paulo"
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
                                            ...
                                            <input type="text" name="cep_de" id="cep_de" value="{{ old('cep_de') }}" required data-mask="cep" placeholder="00000-000"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
                                            ...
                                            <input type="text" name="cep_ate" id="cep_ate" value="{{ old('cep_ate') }}" required data-mask="cep" placeholder="00000-000"
                                                class="flex-1 min-w-0 py-2.5 pr-4 pl-0 bg-transparent border-0 text-gray-900 dark:text-white text-sm font-mono focus:outline-none focus:ring-0 placeholder:text-gray-400">
                                        </div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <select name="tipo" id="tipo"
                                        ...
                                        <option value="total" {{ old('tipo') == 'total' ? 'selected' : '' }}>Total</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="pt-6 flex items-center justify-end gap-3 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button type="submit" class="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2">
