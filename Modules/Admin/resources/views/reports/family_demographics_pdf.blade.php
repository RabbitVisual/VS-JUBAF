...
<body>
    ...
    @if (!empty($liderancaalHighlights))
        <div class="section">
            <div class="section-title">Destaques liderancaais</div>
            <ul class="highlights">
                @foreach ($liderancaalHighlights as $h)
                    <li>{{ $h }}</li>
                @endforeach
            </ul>
        </div>
    ...
    <div class="footer">
        Documento gerado pelo VertexCBAV. Uso interno – reuniões de conselho e planejamento liderancaal.
    </div>
</body>
