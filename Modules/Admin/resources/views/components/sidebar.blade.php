    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.users*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Membros</a>
            ...
            <a href="{{ route('admin.notifications.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.notifications*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Notificações</a>
            <a href="{{ route('admin.bible.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.bible*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Bíblia</a>
            <a href="{{ route('admin.sermons.sermons.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.sermons*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Sermões</a>
            <a href="{{ route('admin.events.events.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.events*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Eventos</a>
            ...
            <a href="{{ route('admin.transactions.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.transactions*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Transações</a>
            <a href="{{ route('admin.payment-gateways.index') }}"
                class="flex items-center px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('admin.payment-gateways*') ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800/50' }}">Gateways</a>
        </nav>
    </div>
</aside>
