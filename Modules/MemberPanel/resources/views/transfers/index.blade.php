            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800">
                ...
                @else
                    <div class="px-6 py-10 text-center">
                        <div
                            class="w-16 h-16 mx-auto mb-4 rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-gray-400">
                        ...
                        <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">
                            Quando você solicitar uma carta de transferência, ela aparecerá aqui com o andamento do
                            processo.
                        </p>
                    </div>
                @endif
