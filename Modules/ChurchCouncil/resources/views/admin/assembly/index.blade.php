                ...
                @foreach($agendas as $agenda)
                    <div class="px-6 py-4 flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 text-[11px] font-bold uppercase tracking-wide">
                                Aguardando assembleia
                            </span>
                            <a href="{{ route('admin.churchcouncil.assembly.edit', $agenda) }}"
