...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Adicione um novo membro ao conselho da igreja.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <select name="user_id" id="user_id" required
                                ...
                                <option value="">Selecione um usuário para adicionar ao conselho</option>
                    ...
                    <div>
                        ...
                        <input type="date" name="term_end" id="term_end"
                            class="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all">
                        <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">Deixe em branco para mandatos por tempo indeterminado.</p>
                    </div>
...
document.getElementById('createMemberForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('{{ route("admin.churchcouncil.members.store") }}', {
            method: 'POST',
            headers: {
