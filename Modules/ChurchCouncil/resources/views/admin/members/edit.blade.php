                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="council_role" id="council_role" required
                                    ...
                                    <option value="president" {{ $member->council_role === 'president' ? 'selected' : '' }}>
                                        Presidente</option>
                                    <option value="vice_president"
                                        {{ $member->council_role === 'vice_president' ? 'selected' : '' }}>Vice-Presidente
                                    </option>
                                    <option value="secretary" {{ $member->council_role === 'secretary' ? 'selected' : '' }}>
                                        Secretário</option>
                                    <option value="treasurer" {{ $member->council_role === 'treasurer' ? 'selected' : '' }}>
                                        Tesoureiro</option>
                                    <option value="lideranca"
                                        {{ $member->council_role === 'lideranca' ? 'selected' : '' }}>lideranca</option>
                                    <option value="deacon" {{ $member->council_role === 'deacon' ? 'selected' : '' }}>
                                        Diácono</option>
                                    <option value="member" {{ $member->council_role === 'member' ? 'selected' : '' }}>
                                        Membro</option>
                                </select>
            ...
            try {
                ...
                if (result.success) {
                    window.location.href = result.redirect ||
                        '{{ route('admin.churchcouncil.members.index') }}';
                } else {
