...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
        <form method="GET" action="{{ route('admin.churchcouncil.meetings.index') }}" class="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div class="md:col-span-3">
                <label for="date_from" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">A partir de</label>
                <div class="relative">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col md:items-end gap-3 flex-shrink-0">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('admin.churchcouncil.meetings.show', $meeting) }}"
