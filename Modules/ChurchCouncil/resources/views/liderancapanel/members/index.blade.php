    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-1">{{ __('churchcouncil::messages.counselors_registered') }}
                </p>
            </div>
            <a href="{{ route('pastor.conselho.index') }}"
