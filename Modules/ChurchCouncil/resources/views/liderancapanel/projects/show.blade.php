        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <nav class="flex items-center gap-2 text-sm text-slate-400 font-medium mb-1">
                    ...
                    <a href="{{ route('pastor.conselho.projects.index') }}"
                        class="hover:text-white transition-colors">{{ __('churchcouncil::messages.projects') }}</a>
                    <x-icon name="chevron-right" class="w-3.5 h-3.5" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-200 dark:border-slate-700">
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white font-medium">
                        {{ $project->proposer->name ?? __('churchcouncil::messages.no_info') }}</p>
                </div>
                @if ($project->ministry)
                    <div>
