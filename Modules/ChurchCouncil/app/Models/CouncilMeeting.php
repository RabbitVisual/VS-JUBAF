...
class CouncilMeeting extends Model
{
    ...
    {
        return $this->belongsTo(CouncilMember::class, 'president_id');
    }
    ...
    {
        return $this->hasMany(CouncilAgenda::class, 'meeting_id')->orderBy('order');
    }

    public function minutesVersions(): HasMany
    {
        return $this->hasMany(MeetingMinutesVersion::class, 'council_meeting_id')->orderByDesc('version');
    }
    ...
    public function getParticipantMembersAttribute()
    {
        ...
        return CouncilMember::with('user')->whereIn('id', $this->participants)->get();
    }
