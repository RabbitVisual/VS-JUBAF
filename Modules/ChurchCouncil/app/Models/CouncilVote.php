...
class CouncilVote extends Model
{
    ...
    {
        return $this->belongsTo(CouncilAgenda::class, 'agenda_id');
    }

    /**
     * Get the council member who cast this vote
     */
    ...
    /**
     * Scope for votes by council member
     */
    public function scopeByMember($query, int $memberId)
    {
        return $query->where('council_member_id', $memberId);
    }
}
