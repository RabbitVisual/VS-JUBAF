...
class CouncilMinistriesDashboardController extends Controller
{
    /**
    ...
    public function index(Request $request): View
    {
        ...
        $planStatuses = MinistryPlan::whereIn('ministry_id', $ministries->pluck('id'))
            ->whereIn('status', [MinistryPlan::STATUS_UNDER_COUNCIL_REVIEW, MinistryPlan::STATUS_APPROVED, MinistryPlan::STATUS_IN_EXECUTION])
            ->get()
            ->groupBy('ministry_id')
        ...
        $pendingPlanApprovals = \Modules\ChurchCouncil\App\Models\CouncilApproval::where('approval_type', \Modules\ChurchCouncil\App\Models\CouncilApproval::TYPE_MINISTRY_PLAN)
        ...
        return view('churchcouncil::admin.ministries-dashboard.index', compact(
            'ministries',
            'planStatuses',
            'reportSubmitted',
            'trafficLights',
