...
use Modules\ChurchCouncil\App\Models\DisciplineAction;
use Modules\ChurchCouncil\App\Models\DisciplineCase;
use Modules\ChurchCouncil\App\Models\DisciplineCaseFile;
...
class DisciplineController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('churchcouncil::admin.discipline.index', compact('cases'));
    }
    ...
    public function create(): View
    {
        ...
        return view('churchcouncil::admin.discipline.create', compact('users'));
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if ($councilUsers->isNotEmpty()) {
            $this->inApp->sendToUsers(
                ...
                [
                    'type' => 'warning',
                    'priority' => 'high',
                    'action_url' => route('admin.churchcouncil.discipline.show', $case),
        ...
        return response()->json([
            ...
            'redirect' => route('admin.churchcouncil.discipline.index'),
        ]);
    }
    ...
    public function show(DisciplineCase $case): View
    {
        ...
        return view('churchcouncil::admin.discipline.show', compact('case'));
    }
    ...
    public function uploadFile(Request $request, DisciplineCase $case): JsonResponse
    {
        ...
        $file = $validated['file'];
        $path = $file->store('churchcouncil/discipline', 'protected');
