...
namespace Modules\ChurchCouncil\App\Http\Controllers\Api\V1;
 ...
 */
class ChurchCouncilController extends Controller
{
    ...
    /**
     * GET /api/v1/church-council – lista reuniões (paginado).
     */
    ...
    /**
     * PUT/PATCH /api/v1/church-council/{id}
     */
    ...
    /**
     * DELETE /api/v1/church-council/{id}
     */
    ...
    /**
     * GET /api/v1/church-council/members
     */
    ...
    /**
     * GET /api/v1/church-council/agendas
     */
    ...
    /**
     * GET /api/v1/church-council/agendas/{id}
     */
    ...
    /**
     * POST /api/v1/church-council/agendas/{id}/vote
     */
    public function agendaVote(Request $request, int $id): JsonResponse
    {
        $agenda = CouncilAgenda::find($id);
        if (! $agenda) {
            return response()->json(['message' => 'Pauta não encontrada.'], 404);
        }
        $member = $request->user()?->councilMember;
    ...
    /**
     * GET /api/v1/church-council/approvals
     */
    ...
    /**
     * GET /api/v1/church-council/documents
     */
    ...
    /**
     * GET /api/v1/church-council/projects
     */
