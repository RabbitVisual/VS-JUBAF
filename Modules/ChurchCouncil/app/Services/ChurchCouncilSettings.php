...
/**
 * Central access to Church Council settings stored in App\Models\Settings (church_council_* keys).
 * Use this service everywhere (admin, member panel, PDFs, approvals) so settings are applied consistently.
 */
class ChurchCouncilSettings
{
    public const KEY_NAME = 'church_council_name';

    public const KEY_MEETING_FREQUENCY = 'church_council_meeting_frequency';

    public const KEY_QUORUM_PERCENTAGE = 'church_council_quorum_percentage';

    public const KEY_VOTING_DEADLINE_DAYS = 'church_council_voting_deadline_days';

    public const KEY_AUTO_APPROVE_BUDGET_LIMIT = 'church_council_auto_approve_budget_limit';

    public const KEY_APPROVAL_DEADLINE_DAYS = 'church_council_approval_deadline_days';

    public const KEY_ENABLED_APPROVAL_TYPES = 'church_council_enabled_approval_types';

    public const KEY_EMAIL_NOTIFICATIONS = 'church_council_email_notifications';

    public const KEY_REMINDER_NOTIFICATIONS = 'church_council_reminder_notifications';

    public const KEY_VOTING_REMINDERS = 'church_council_voting_reminders';

    public const KEY_ALLOW_ADMIN_APPROVAL = 'church_council_allow_admin_approval';
    ...
    /**
     * Council display name (used in titles, PDFs, member panel, admin).
     */
    ...
    /**
     * Return all council settings as a keyed array (form keys: council_name, meeting_frequency, ...).
