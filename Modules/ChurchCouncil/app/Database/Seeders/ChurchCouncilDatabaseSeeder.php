...
namespace Modules\ChurchCouncil\App\Database\Seeders;
...
class ChurchCouncilDatabaseSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        CouncilMember::firstOrCreate(
            ...
            [
                'council_position' => 'Presidente',
                'council_role' => 'president',
