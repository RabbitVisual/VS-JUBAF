...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $eliasInsight = null;
        if (class_exists(CbavBotRuleEngineService::class)) {
            $engine = app(CbavBotRuleEngineService::class);
            $eliasInsight = $engine->evaluate(auth()->user(), 'pastor.dashboard');
        }

        return view('pastoralpanel::dashboard', compact('stats', 'aniversariantes', 'pedidosOracaoPendentes', 'eliasInsight'));
    }
