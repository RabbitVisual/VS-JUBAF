...
class EventosController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('events::pastoralpanel.index', compact('events', 'eventTypes'));
    }
    ...
    public function show(Event $event): View
    {
        ...
        return view('events::pastoralpanel.show', compact('event'));
    }
    ...
    public function registrationsIndex(Event $event, Request $request): View
    {
        ...
        return view('events::pastoralpanel.registrations.index', compact('event', 'registrations'));
    }
    ...
    public function registrationShow(Event $event, EventRegistration $registration): View
    {
        ...
        return view('events::pastoralpanel.registrations.show', compact('event', 'registration'));
    }
    ...
    public function checkinIndex(): View
    {
        ...
        return view('events::pastoralpanel.checkin.scanner');
    }
