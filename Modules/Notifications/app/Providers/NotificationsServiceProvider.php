...
use Modules\Notifications\App\Services\NotificationTemplateResolver;
...
class NotificationsServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->singleton(InAppNotificationService::class, fn () => new InAppNotificationService);
        $this->app->singleton(CircuitBreakerService::class, fn () => new CircuitBreakerService);
        $this->app->singleton(NotificationTemplateResolver::class, fn () => new NotificationTemplateResolver);
        $this->app->singleton(NotificationDispatcherService::class, function ($app) {
            return new NotificationDispatcherService(
                ...
                $app->make(NotificationTemplateResolver::class)
            );
        });
    ...
    {
        $this->commands([
            \Modules\Notifications\App\Console\NotificationsPurgeCommand::class,
        ]);
    }
    ...
    public function provides(): array
    {
        ...
        NotificationTemplateResolver::class,
