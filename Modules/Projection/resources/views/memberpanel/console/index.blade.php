...
<head>
    ...
    <title>Console de Projeção - VertexCBAV</title>
...
<body class="bg-slate-950 text-white antialiased overflow-hidden">
    <div id="projection-app"
         ...
         data-dashboard-url="{{ route('memberpanel.dashboard') }}"
         data-context="member"
         data-initial-setlist-id="{{ $setlist?->id ?? '' }}"
         class="h-screen w-screen overflow-hidden bg-slate-900 border-none outline-none">

        <!-- Loading State -->
        <div class="flex flex-col items-center justify-center h-screen bg-slate-950 text-white">
