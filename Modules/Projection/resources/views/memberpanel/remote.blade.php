    ...
    <div class="max-w-lg mx-auto pb-6 px-3">
        <header class="py-4 border-b border-slate-800">
            <div class="flex items-center justify-between">
                <a href="{{ route('memberpanel.projection.index') }}" class="text-slate-500 hover:text-white p-1">
                ...
                <span class="text-[10px] font-bold text-slate-500 truncate max-w-[100px] text-right" x-text="liveTitle || '—'"></span>
            </div>
