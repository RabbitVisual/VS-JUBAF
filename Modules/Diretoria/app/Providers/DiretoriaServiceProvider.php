...
class DiretoriaServiceProvider extends ServiceProvider
{
    ...
    /**
     * Share diretoria display name and settings to Church diretoria views.
     */
    protected function registerViewComposers(): void
    {
        // Read diretoria name at view-render time so settings changes apply immediately (no boot-time capture).
        $injectdiretoriaName = function ($view) {
    ...
    /**
     * Register model observers for diretoria notifications.
     */
