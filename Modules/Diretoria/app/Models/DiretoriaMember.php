...
class DiretoriaMember extends Model
{
    ...
    /**
     * Get the user associated with this diretoria member
     */
    ...
    {
        return $this->diretoria_role === $role;
    }
    ...
    {
        return self::getRoleDisplayName($this->diretoria_role);
    }
    ...
    {
        return $query->where('diretoria_role', $role);
    }
}
