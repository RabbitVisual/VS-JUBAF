...
class TransferLetterController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('Diretoria::admin.transfers.index', compact('letters'));
    }
    ...
    public function create(): View
    {
        ...
        return view('Diretoria::admin.transfers.create', compact('users'));
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $status = $validated['direction'] === TransferLetter::DIRECTION_OUTGOING
            ? TransferLetter::STATUS_PENDING_diretoria
        ...
        return response()->json([
            ...
            'redirect' => route('admin.Diretoria.transfers.index'),
        ]);
    }
    ...
    public function show(TransferLetter $letter): View
    {
        ...
        return view('Diretoria::admin.transfers.show', compact('letter'));
    }
    ...
    public function uploadDocument(Request $request, TransferLetter $letter): JsonResponse
    {
        ...
        $path = $validated['file']->store('Diretoria/transfers', 'public');
