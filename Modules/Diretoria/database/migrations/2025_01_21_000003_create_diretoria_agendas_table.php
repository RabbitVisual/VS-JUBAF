...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('diretoria_agendas', function (Blueprint $table) {
            ...
            $table->foreignId('presented_by')->nullable()->constrained('diretoria_members')->nullOnDelete();
            $table->text('discussion_notes')->nullable();
            $table->text('decision')->nullable();
            $table->foreignId('decided_by')->nullable()->constrained('diretoria_members')->nullOnDelete();
