        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400 mt-1">
                    Acompanhamento liderancaal de disciplina e restauração, conforme Mateus 18 e princípios batistas.
                </p>
            </div>
            <a href="{{ route('admin.Diretoria.discipline.create') }}"
            ...
            @if ($cases->count() > 0)
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    @foreach ($cases as $case)
                        <a href="{{ route('admin.Diretoria.discipline.show', $case) }}"
