...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <form action="{{ route('admin.Diretoria.documents.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="document_date" required value="{{ date('Y-m-d') }}"
                        class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg py-2.5 px-4 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg py-2.5 px-4 focus:ring-blue-500 focus:border-blue-500"></textarea>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <select name="meeting_id"
                        ...
                        @foreach ($meetings as $meeting)
                            <option value="{{ $meeting->id }}">{{ $meeting->scheduled_date->format('d/m/Y') }} -
                ...
                <!-- File Upload -->
                <div class="col-span-2">
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Arquivo * (PDF, Word,
                        Excel)</label>
                ...
                <div class="col-span-2">
                    <div
                        ...
                        <label for="is_public"
                            ...
                            <p class="text-xs font-normal text-gray-500 mt-0.5">Se marcado, qualquer membro da igreja poderá
                                visualizar este documento no painel.</p>
                        </label>
                    </div>
                </div>
            </div>
