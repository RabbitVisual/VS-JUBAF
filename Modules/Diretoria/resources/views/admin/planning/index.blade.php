...
@section('content')
    <div class="p-6 space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <form method="GET" action="{{ route('admin.Diretoria.planning.index') }}"
                ...
                <div class="space-y-1">
                    ...
                    <select name="ministry_id"
                        class="block w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 text-sm text-gray-900 dark:text-white px-3 py-2">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    @foreach ($approvals as $approval)
                        @php
                            ...
                            $event =
                                $approval->approvable instanceof \Modules\Events\App\Models\Event
                                    ? $approval->approvable
                                    : null;
                        @endphp
                        <div class="px-5 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                            <div class="space-y-1">
                                <div class="flex items-center gap-2">
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300">
                            ...
                            <div class="flex flex-wrap items-center gap-2 justify-end">
                                ...
                                <button type="button"
                                    ...
                                    data-approve-url="{{ route('admin.Diretoria.approvals.approve', $approval) }}">
                                ...
                                <button type="button"
                                    ...
                                    data-reject-url="{{ route('admin.Diretoria.approvals.reject', $approval) }}">
