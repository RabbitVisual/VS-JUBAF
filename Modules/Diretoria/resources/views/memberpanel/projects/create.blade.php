...
@section('content')
    <div
        ...
        <div class="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Nova Proposta de Projeto
                    </h1>
                    <p class="text-gray-500 dark:text-slate-400 mt-1">Preencha o formulário abaixo para submeter um novo
                        projeto à diretoria.</p>
                </div>
            ...
            <!-- Form -->
            <div
                class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm dark:shadow-lg border border-gray-200 dark:border-slate-800 p-6 md:p-8 transition-colors duration-200">
                <form id="createProjectForm" class="space-y-8">
                    ...
                    <div>
                        <h3
                            class="text-lg font-black text-gray-900 dark:text-white mb-6 flex items-center gap-3 border-b border-gray-100 dark:border-slate-800 pb-2">
                            <span
                                class="w-8 h-8 rounded-lg bg-purple-100 dark:bg-purple-500/10 flex items-center justify-center text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/20 font-bold">
                                1
                            </span>
                            Informações Básicas
                        </h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute left-4 top-2.5 text-gray-500 dark:text-slate-500 font-bold">R$</span>
                    ...
                    <!-- Form Actions -->
                    <div
                        class="flex flex-col md:flex-row justify-end gap-3 pt-6 border-t border-gray-100 dark:border-slate-800">
                        <a href="{{ route('memberpanel.Diretoria.projects.index') }}"
    ...
    <script>
        document.getElementById('createProjectForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('{{ route('memberpanel.Diretoria.projects.store') }}', {
                    method: 'POST',
                    headers: {
