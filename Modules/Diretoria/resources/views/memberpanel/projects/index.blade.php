...
@section('content')
    <div
        ...
        <!-- Hero Section -->
        <div
            class="relative bg-linear-to-r from-purple-900 to-purple-800 dark:from-slate-900 dark:to-slate-950 border-b border-purple-200 dark:border-purple-900/30 p-6 md:p-10 transition-colors duration-200">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="flex-1 text-center md:text-left space-y-2">
                    <p class="text-purple-200 dark:text-purple-500 font-bold uppercase tracking-widest text-xs">Ideias e
                        Realizações</p>
                ...
                <a href="{{ route('memberpanel.Diretoria.projects.create') }}"
                    ...
                    <x-icon name="plus"
                        class="w-5 h-5 mr-2 text-purple-600 dark:text-white group-hover:scale-110 transition-transform" />
                    Nova Proposta
                </a>
            </div>
        </div>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col">
                                            <span
                                                class="text-sm font-bold text-gray-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">{{ $project->title }}</span>
                                            <span
                                                class="text-xs text-gray-500 dark:text-slate-500 mt-0.5 line-clamp-1 max-w-xs">{{ $project->description }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-slate-300">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-6 h-6 rounded-full bg-purple-100 dark:bg-slate-800 border border-purple-200 dark:border-slate-700 flex items-center justify-center text-xs font-bold text-purple-600 dark:text-purple-400">
                                    ...
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-mono font-medium text-gray-600 dark:text-slate-300">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-16 text-center text-gray-500 dark:text-slate-500">
                                        <div class="flex flex-col items-center justify-center">
                                            <div
                                                class="w-16 h-16 bg-gray-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-4 border border-gray-200 dark:border-slate-700">
                                                <x-icon name="lightbulb"
                                                    class="w-8 h-8 text-gray-400 dark:text-slate-500" />
                                            </div>
                                            <p class="text-xl font-bold text-gray-900 dark:text-white mb-2">Nenhum projeto
                                                encontrado</p>
                                            <p class="text-gray-500 dark:text-slate-400 mb-6">Seja o primeiro a submeter uma
                                                proposta de projeto!</p>
                                            <a href="{{ route('memberpanel.Diretoria.projects.create') }}"
