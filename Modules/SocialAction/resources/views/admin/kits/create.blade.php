...
@section('title', 'Novo Kit | Ação Social')
...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Novo Kit</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">Componha um novo kit de itens.</p>
            </div>
        </div>
    </div>

    <div class="max-w-4xl mx-auto" x-data="kitForm()">
        <form action="{{ route('socialaction.admin.kits.store') }}" method="POST">
            @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3"
                                    ...
                                    placeholder="Detalhes sobre a composição..."></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-3xl p-6 border border-blue-100 dark:border-blue-800">
                        ...
                        <p class="text-sm text-blue-600 dark:text-blue-400 mb-4">
                            Este kit será salvo como um modelo padrão. Ao entregar este kit, o estoque será descontado automaticamente para todos os itens listados.
                        </p>
