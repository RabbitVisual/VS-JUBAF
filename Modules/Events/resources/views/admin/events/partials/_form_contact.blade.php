...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2 flex flex-wrap gap-6">
            ...
            @if(class_exists(\Modules\ChurchCouncil\App\Models\CouncilApproval::class))
            <label class="flex items-center gap-3 cursor-pointer group">
                <div class="relative">
                ...
                <div>
                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
                        <x-icon name="shield-check" style="duotone" class="w-4 h-4 text-indigo-500" /> Requer Aprovação do Conselho
                    </span>
                    <span class="text-xs text-gray-500 dark:text-gray-400">Evento fica em rascunho até o conselho aprovar</span>
                </div>
            </label>
            @endif
        </div>
