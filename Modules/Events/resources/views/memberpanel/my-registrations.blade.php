    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 pt-4 sm:pt-6 space-y-6 sm:space-y-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
                ...
                <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Minhas Inscrições JUBAF</h1>
                <p class="text-gray-500 dark:text-slate-400 mt-1 text-sm max-w-xl">Acompanhe sua jornada nos eventos da Juventude Batista Feirense.</p>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="flex-1 space-y-2">
                    <div class="flex items-center gap-3">
                        <span title="Status geral da inscrição no sistema do evento." class="cursor-help px-3 py-1 text-xs font-black rounded-full uppercase tracking-wider
                        ...
                        <span title="{{ $isPaid ? 'Pagamento confirmado para participação no evento.' : 'Inscrição criada e aguardando pagamento.' }}" class="cursor-help px-3 py-1 text-xs font-black rounded-full uppercase tracking-wider {{ $isPaid ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400' : 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400' }}">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 dark:border-slate-800 p-8 sm:p-12 text-center">
            ...
            <h3 class="text-xl font-black text-gray-900 dark:text-white mb-2">Você ainda não possui inscrições</h3>
            <p class="text-gray-500 dark:text-slate-400 text-sm max-w-md mx-auto mb-6 sm:mb-8">
                Participe dos próximos eventos da JUBAF e acompanhe tudo por aqui.
            </p>
            <a href="{{ route('memberpanel.events.index') }}"
