            ...
            <div class="relative p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <div class="flex items-center gap-3 mb-2 flex-wrap">
                        ...
                        <span class="px-3 py-1 rounded-full bg-green-500/20 border border-green-400/30 text-green-300 text-xs font-bold uppercase tracking-wider">Locais</span>
                    </div>
                    <h1 class="text-3xl md:text-4xl font-black tracking-tight mb-2">Locais de Armazenamento</h1>
                    <p class="text-gray-300 max-w-xl">Onde os bens estão guardados (salas, depósitos, etc.).</p>
                </div>
                <a href="{{ route('assets.admin.locations.create') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-gray-900 font-bold hover:bg-gray-100 transition-all shadow-lg shadow-white/10">
                        ...
                        @foreach ($locations as $location)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('assets.admin.locations.edit', $location->id) }}" class="text-gray-400 hover:text-blue-600 transition-colors" title="Editar">
