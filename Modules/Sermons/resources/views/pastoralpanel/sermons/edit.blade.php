...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- Form -->
        <form id="sermon-form" action="{{ route('pastor.sermoes.sermons.update', $sermon) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form method="post" action="{{ route('pastor.sermoes.sermons.collaborators.invite', $sermon) }}" class="flex gap-2">
                    @csrf
