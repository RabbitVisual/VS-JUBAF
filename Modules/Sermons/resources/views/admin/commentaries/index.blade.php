        ...
        <form method="GET" action="{{ route('admin.sermons.commentaries.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex gap-2">
                ...
                @if (request()->hasAny(['search', 'book']))
                    <a href="{{ route('admin.sermons.commentaries.index') }}" class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600">
                        Limpar
                    </a>
                @endif
            </div>
