...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <form action="{{ route('lideranca.sermoes.studies.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="archived" {{ old('status') == 'archived' ? 'selected' : '' }}>Arquivado
                            </option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="visibility" id="visibility" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            <option value="public" {{ old('visibility', 'members') == 'public' ? 'selected' : '' }}>
                                Público</option>
                            <option value="members" {{ old('visibility', 'members') == 'members' ? 'selected' : '' }}>
                                Membros</option>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <input type="checkbox" name="is_featured" id="is_featured" value="1"
                        {{ old('is_featured') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded">
