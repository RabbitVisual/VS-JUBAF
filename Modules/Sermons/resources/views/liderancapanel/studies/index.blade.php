        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <form method="GET" action="{{ route('lideranca.sermoes.studies.index') }}"
                ...
                <div class="flex gap-2">
                    <button type="submit"
                        class="px-4 py-2 bg-amber-500 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-amber-500">
                        Filtrar
                    </button>
                                        ...
                                        <div class="h-10 w-10 flex-shrink-0">
                                            @if ($study->cover_image)
                                                <img class="h-10 w-10 rounded-lg object-cover"
                                                    src="{{ asset('storage/' . $study->cover_image) }}" alt="">
                                            @else
                                                <div
                                        ...
                                        <div class="ml-4">
                                            ...
                                            @if ($study->subtitle)
                                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ Str::limit($study->subtitle, 40) }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12">
                                    <div class="flex flex-col items-center justify-center text-center max-w-sm mx-auto">
                                        ...
                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Nenhum estudo ainda
                                        </h3>
