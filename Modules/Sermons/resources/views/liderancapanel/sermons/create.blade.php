                                ...
                                <select name="worship_suggestion_id" id="worship_suggestion_id"
                                    ...
                                    @foreach ($worshipSongs as $song)
                                        <option value="{{ $song->id }}"
                                            {{ old('worship_suggestion_id') == $song->id ? 'selected' : '' }}>
                                            {{ $song->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:col-span-2">
                            ...
                            <div>
                                ...
                                <input type="date" name="sermon_date" id="sermon_date"
                                    value="{{ old('sermon_date', now()->format('Y-m-d')) }}"
                                    class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 shadow-sm focus:border-amber-500 focus:ring-amber-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                            </div>
                            ...
                            <div class="flex flex-col gap-2 md:col-span-2">
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    <label class="inline-flex items-center gap-2 cursor-pointer">
                                        ...
                                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Publicar para a
                                            Igreja</span>
                                    </label>
                                    <div class="flex gap-4">
                                        <div>
                                            <label for="status"
                                                class="block text-xs font-bold text-gray-500 dark:text-gray-400">Status</label>
                                            <select name="status" id="status"
                                                class="mt-0.5 block w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-amber-500 focus:ring-amber-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                                        ...
                                        <div>
                                            <label for="visibility"
                                                class="block text-xs font-bold text-gray-500 dark:text-gray-400">Visibilidade</label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="sermon_structure_type" id="sermon_structure_type"
                                    ...
                                    <option value="expositivo"
                                        {{ old('sermon_structure_type') === 'expositivo' ? 'selected' : '' }}>Expositivo
                                    </option>
                                    <option value="temático"
                                        {{ old('sermon_structure_type') === 'temático' ? 'selected' : '' }}>Temático
                                    </option>
                                    <option value="textual"
                                        {{ old('sermon_structure_type') === 'textual' ? 'selected' : '' }}>Textual</option>
                                </select>
                                <div
                                    ...
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Guia visual para as seções do
                                        sermão (Isaltino Coelho).</p>
                                </div>
                            </div>
                        </div>
                    </div>
