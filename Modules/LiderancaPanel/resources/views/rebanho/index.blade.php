        ...
        <div
            ...
            <form action="{{ route('pastor.rebanho.index') }}" method="GET"
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-medium flex items-center gap-2">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    <thead
                        class="bg-gray-50 dark:bg-slate-700/50 text-gray-600 dark:text-gray-400 uppercase text-xs font-bold">
                        <tr>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-slate-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">Nenhum
                                    membro encontrado.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
