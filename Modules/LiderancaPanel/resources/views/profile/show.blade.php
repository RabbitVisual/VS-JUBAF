            ...
            <div class="relative p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <div class="flex items-center gap-3 mb-2 flex-wrap">
                        ...
                        <span class="px-3 py-1 rounded-full bg-green-500/20 border border-green-400/30 text-green-300 text-xs font-bold uppercase tracking-wider">{{ $user->role->name ?? 'Liderança' }}</span>
                    </div>
                ...
                <div class="shrink-0">
                    <a href="{{ route('lideranca.profile.edit') }}" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-gray-900 font-bold hover:bg-gray-100 transition-all shadow-lg shadow-white/10">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-4 space-y-6">
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700 sticky top-6">
                    ...
                    <!-- Banner Background -->
                    <div class="h-32 bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 relative">
            ...
            <div class="col-span-12 lg:col-span-8 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 relative overflow-hidden">
                    ...
                    <div class="relative flex items-center justify-between gap-4 mb-4">
                        ...
                        <a href="{{ route('lideranca.rebanho.edit', $user) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold transition-all shadow-sm">
                            ...
                            @foreach($user->relationships as $rel)
                                <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-100 dark:border-gray-700">
                                    @if($rel->related_user_id && $rel->relatedUser)
                                        <a href="{{ route('lideranca.rebanho.show', $rel->relatedUser) }}" class="shrink-0">
                                        ...
                                        <div class="min-w-0">
                                            <a href="{{ route('lideranca.rebanho.show', $rel->relatedUser) }}" class="font-bold text-gray-900 dark:text-white hover:text-emerald-600 block truncate">{{ $rel->relatedUser->name }}</a>
