...
@section('page-title', 'Nova Entrada Financeira')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-200 pb-12">
        <div class="max-w-4xl mx-auto space-y-8 px-6 pt-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Nova entrada financeira</h1>
                    <p class="text-gray-500 dark:text-slate-400 mt-1 max-w-md">Registrar movimentação para auditoria.</p>
                </div>
            ...
            <form action="{{ route('memberpanel.treasury.entries.store') }}" method="POST" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <select name="category" required
                            ...
                            <optgroup label="Receitas" class="font-black text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20">
                                ...
                                <option value="ministry_donation">Doação para Ministério</option>
                                <option value="campaign">Campanha</option>
                            </optgroup>
                            <optgroup label="Despesas" class="font-black text-rose-600 bg-rose-50 dark:bg-rose-950/20">
                                <option value="maintenance">Manutenção</option>
                                <option value="utilities">Contas Fixas</option>
                                <option value="salary">Salários/Ajuda de Custo</option>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white font-medium focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all placeholder:text-slate-400"
                        placeholder="Informações adicionais para o conselho fiscal...">{{ old('description') }}</textarea>
                </div>
