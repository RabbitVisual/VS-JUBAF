...
@section('title', 'Nova Categoria - Intercessão')
...
<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="space-y-1">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Nova Categoria</h1>
            <p class="text-gray-600 dark:text-gray-400">Crie uma nova categoria para organizar os pedidos de oração.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 max-w-4xl">
        <form action="{{ route('admin.intercessor.categories.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-gray-500 font-medium italic">Esta cor será usada nos badges.</span>
                    </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="3"
                    class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                    placeholder="Descreva o objetivo desta categoria...">{{ old('description') }}</textarea>
