...
<form action="{{ $formAction }}" method="POST" enctype="multipart/form-data" class="space-y-8"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                <label for="nome" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nome da
                    Igreja *</label>
            ...
            <div>
                <label for="pastor_titular"
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pastor Titular</label>
                <input type="text" name="pastor_titular" id="pastor_titular" value="{{ $pastorValue }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>

            <div>
                <label for="lider_jovens" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Líder
                    de Jovens</label>
                <input type="text" name="lider_jovens" id="lider_jovens"
                    value="{{ old('lider_jovens', $igreja->lider_jovens) }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
            ...
            <div>
                <label for="estado" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Estado
                    (UF)</label>
                <input type="text" name="estado" id="estado" maxlength="2"
                    value="{{ old('estado', $igreja->estado) }}"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 md:p-8">
        <div class="flex items-start gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Use imagem quadrada para melhor resultado visual.
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-5">
            ...
            <label
                class="cursor-pointer inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
    ...
    <div class="flex items-center justify-end gap-3">
        <a href="{{ route('admin.igrejas.index') }}"
            class="px-5 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
            Cancelar
        </a>
        <button type="submit"
            class="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-500/20 transition-colors">
