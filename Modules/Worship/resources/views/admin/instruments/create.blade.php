...
@section('title', 'Novo Instrumento | Worship')
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <h1 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight leading-tight uppercase italic">Novo <span class="text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400">Instrumento</span></h1>
                </div>
            </div>
        </div>

        <div class="max-w-2xl mx-auto">
            <form action="{{ route('worship.admin.instruments.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-200 dark:border-gray-700 shadow-sm p-8 md:p-10 space-y-8 relative overflow-hidden">
                    ...
                    <div class="flex items-center gap-5 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter italic">Registro Técnico</h3>
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-0.5">Cadastre uma nova função na escala do btlh.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 relative z-10">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" required value="{{ old('name') }}" placeholder="Ex: Saxofone Tenor"
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="icon" required value="{{ old('icon') }}" placeholder="Ex: music-note"
